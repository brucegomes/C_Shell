...
// @brief prints a node in the list by matching id, returns 1 if found 0 if not
void print_execByID(LinkedList* histList, int id);

// @brief return id of last node ie command
